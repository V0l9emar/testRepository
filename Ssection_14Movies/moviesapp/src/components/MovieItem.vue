  ...
  <div class="movie-item mb-3">
    ...
    <div class="movie-info-wrap d-flex flex-column justify-content-between">
      <div class="movie-item-info">
        ...
        <p class="movie-plot">Actors: {{ movie.Actors }}</p>
        <p class="movie-plot">Genre: {{ movie.Genre }}</p>
        <span class="movie-year">{{ movie.Year }}</span>
      </div>
      <div class="movie-item-controls row no-gutters">
        <!--div class="col pr-2">
          <BButton size="md" block variant="outline-light" v-b-modal="'my-modal'">About</BButton>
        </div-->
        <div class="col pl-2">
          <BButton
            size="md"
