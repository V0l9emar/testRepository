...
let zero = zeroInArr.some((num) => num == 0);
console.log(zero);
/*
...
let lengt = arrLng.every((str) => str.length >= 3);
console.log(lengt);
/*
...
arrArr.sort((prev, next) => prev.length - next.length);
console.log(arrArr);
...
cpuObj.sort((prev, next) => prev.info.cores - next.info.cores);
console.log(cpuObj);
